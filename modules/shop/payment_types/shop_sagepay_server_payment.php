<?
	...
	class Shop_SagePay_Server_Payment extends Shop_PaymentType
	{
		...
		public function get_info()
		{
			return array(
				...
				'description'=>'UK payment gateway - Sage Pay. "Server" integration method.'
			);
		}
		...
		public function process_payment_notification($params)
		{
			...
			try
			{
				...
				if (!($payment_method_obj instanceof Shop_SagePay_Server_Payment))
